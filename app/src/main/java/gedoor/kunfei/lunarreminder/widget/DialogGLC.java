package gedoor.kunfei.lunarreminder.widget;
...
import gedoor.kunfei.lunarreminder.ui.activity.EventEditActivity;
import gedoor.kunfei.lunarreminder.util.ChineseCalendar;
import gedoor.kunfei.lunarreminder.R;
import gedoor.kunfei.lunarreminder.widget.indicatorview.IndicatorView;
...
public class DialogGLC extends Dialog implements View.OnClickListener, IndicatorView.OnIndicatorChangedListener {
    ...
    EventEditActivity.DialogListener dialogListener;

    public DialogGLC(Context context, EventEditActivity.DialogListener dialogListener) {
