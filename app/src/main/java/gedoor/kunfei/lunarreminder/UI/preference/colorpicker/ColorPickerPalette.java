...
import gedoor.kunfei.lunarreminder.UI.preference.colorpicker.*;
import gedoor.kunfei.lunarreminder.UI.preference.colorpicker.ColorPickerSwatch;
import gedoor.kunfei.lunarreminder.UI.preference.colorpicker.ColorPickerSwatch.OnColorSelectedListener;
...
public class ColorPickerPalette extends TableLayout {
    ...
    public void init(int size, int columns, OnColorSelectedListener listener,
        ...
        if (size == gedoor.kunfei.lunarreminder.UI.preference.colorpicker.ColorPickerDialog.SIZE_LARGE) {
     ...
     */
    private gedoor.kunfei.lunarreminder.UI.preference.colorpicker.ColorPickerSwatch createColorSwatch(int color, int selectedColor, int width,
                                                                                int strokeColor) {
        gedoor.kunfei.lunarreminder.UI.preference.colorpicker.ColorPickerSwatch view = new ColorPickerSwatch(getContext(), color,
